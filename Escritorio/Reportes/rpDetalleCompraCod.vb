...
Public Class rpDetalleCompraCod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Escritorio.rpDetalleCompraCod.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prueba() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrpDetalleCompraCod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpDetalleCompraCod = New rpDetalleCompraCod()
        rpt.Site = Me.Site
        Return rpt
    End Function
